...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/Eventing.ts":[function(require,module,exports) {
"use strict";
...
var Eventing = function Eventing() {
  ...
  this.events = new Map(); // public events: { [key: string]: Callback[] } = {};

  this.on = function (eventName, cb) {
    var handlers = _this.events.get(eventName) || [];
    handlers.push(cb);

    _this.events.set(eventName, handlers);
  };
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/ApiSync.ts":[function(require,module,exports) {
"use strict";
...
exports.Attributes = Attributes; //RAPPEL: AVANT TU ECRIVAIS DU CODE COMME ÇA :=) !!
...
function () {
  ...
  _createClass(Model, [{
    ...
    value: function save() {
      ...
      this.sync.save(this.attributes.getAll()).then(function (responce) {
...
exports.User = User;
},{"./Eventing":"src/Eventing.ts","./ApiSync":"src/ApiSync.ts","./models/Attributes":"src/models/Attributes.ts","./models/Model":"src/models/Model.ts","./models/Collection":"src/models/Collection.ts"}],"src/views/View.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(View, [{
    ...
    key: "bindEvent",
    value: function bindEvent(fragment) {
      ...
      var _loop = function _loop(eventKey) {
        ...
        fragment.querySelectorAll(selector).forEach(function (el) {
          return el.addEventListener(eventName, eventMap[eventKey]);
        });
      };

      for (var eventKey in this.eventMap()) {
        _loop(eventKey);
      }
    }
  }, {
...
function (_View_1$View) {
  ...
  _createClass(UserShow, [{
    ...
    value: function template() {
      return "\n<div>\n  <h1>Details Utilisateur</h1>\n  <div>Nom Utilisateur: ".concat(this.model.get("name"), "</div>\n  <div>Nom age: ").concat(this.model.get("age"), "</div>\n</div>\n        ");
    }
  }]);
